...
[![npm version](https://img.shields.io/npm/v/haxios.svg?style=flat-square)](https://www.npmjs.org/package/haxios)
[![install size](https://packagephobia.now.sh/badge?p=haxios)](https://packagephobia.now.sh/result?p=haxios)
[![npm downloads](https://img.shields.io/npm/dm/haxios.svg?style=flat-square)](http://npm-stat.com/charts.html?package=haxios)
...
- Make [fetch](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API) from the browser
- Make [node-fetch](https://www.npmjs.com/package/node-fetch) requests from node.js
